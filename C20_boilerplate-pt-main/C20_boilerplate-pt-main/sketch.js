...
function setup() {
  ...
  block2 = Bodies.rectangle(250,20,190,150,rectangle_options);
  ...
  block3 = Bodies.rectangle(450,10,150,150,quadrado_options);
...
function draw() 
{
  ...
  ellipse(block1.position.x,block1.position.y,120);
  rect(block2.position.x,block2.position.y,140,100);
